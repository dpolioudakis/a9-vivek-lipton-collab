...
pdf(paste("../analysis/intersection_Allen_human_SN-minModSize30-", Sys.Date(), ".pdf"
...
dimnames(allenHumanSNintersect) <- list(allenLabels, liptonLabels)
save(allenHumanSNintersect
